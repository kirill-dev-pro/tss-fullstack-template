...
import { Calendar as CalendarIcon, Loader2, Plus, RefreshCw, ShieldX, Trash, UserCircle } from "lucide-react"
          ...
          <Dialog onOpenChange={setIsBanDialogOpen} open={isBanDialogOpen}>
            <DialogContent>
              ...
              <form className="space-y-4" onSubmit={handleBanUser}>
                ...
                <Button className="w-full" disabled={isLoading === `ban-${banForm.userId}`} type="submit">
