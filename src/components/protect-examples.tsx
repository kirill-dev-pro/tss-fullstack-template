    ...
    <div className="space-y-8 p-6">
      ...
      <div className="space-y-4 text-center">
        <div className="flex items-center justify-center gap-2">
          ...
          <h1 className="text-4xl font-bold">Protect Component Examples</h1>
        </div>
        <p className="mx-auto max-w-3xl text-xl text-muted-foreground">
          Learn how to implement authorization in your React components using
          the Better Auth Protect component. All examples include working demos
      ...
      <Alert>
        ...
        <AlertDescription>
          ...
          {isAuthenticated
            ? `Signed in as ${user?.email} with role: `
            : 'Not signed in '}
          {isAuthenticated && (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Control content based on whether users are signed in or out
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                >
                  <div className="rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-950">
                    <p className="text-green-800 dark:text-green-200">
                      ✅ Welcome! You are signed in and can see this protected
                      content.
                    </p>
                  </div>
                </Protect>
  ...
  <ProtectedContent />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Show content based on user roles (user, admin, superadmin)
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs className="w-full" defaultValue="demo">
    ...
    {hasRole('superadmin') && <SuperAdminPanel />}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Fine-grained access control using resource and action permissions
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs className="w-full" defaultValue="demo">
                ...
                >
                  <div className="rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-800 dark:bg-red-950">
                    <p className="mb-2 text-red-800 dark:text-red-200">
                      ⚠️ You can delete users - use with caution!
                    </p>
  ...
  <div>
    ...
    {canManageBilling && <BillingSettings />}
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>Dynamic Types:</strong> All resource and action types
                  are automatically derived from your{' '}
                  <code>permissions.ts</code> configuration. Add new permissions
                  there and they'll be available here with full TypeScript
                  support!
                </AlertDescription>
              </Alert>
            </TabsContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Complex authorization rules using custom condition functions
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs className="w-full" defaultValue="demo">
                ...
                <Protect
                  condition={({ user: conditionUser }) => {
                    ...
                    return Boolean(
                      conditionUser &&
                      conditionUser.role &&
                      conditionUser.role !== 'user',
                    )
                  }}
                  fallback={
                    <div className="rounded bg-muted p-3 text-sm text-muted-foreground">
                      You need elevated privileges (admin or superadmin) to
                      access this.
                    </div>
                  }
                >
              ...
              <div>
                ...
                <Protect
                  condition={({ user: conditionUser }) => {
                    ...
                    return Boolean(
                      conditionUser?.email?.endsWith('@company.com'),
                    )
                  }}
                  fallback={
                    <div className="rounded bg-muted p-3 text-sm text-muted-foreground">
                      This feature is only available to @company.com email
                      addresses.
                    </div>
                  }
                >
                  <div className="rounded-lg border border-cyan-200 bg-cyan-50 p-4 dark:border-cyan-800 dark:bg-cyan-950">
                    <p className="text-cyan-800 dark:text-cyan-200">
                      🏢 Company Feature: Available to internal users!
                    </p>
                  </div>
                </Protect>
              </div>
  ...
  <BusinessTool />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Pre-built permission helpers and the useAuth hook for complex
            scenarios
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge
                        variant={hasRole('superadmin') ? 'default' : 'outline'}
                      >
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <Alert>
              ...
              <AlertDescription>
                <strong>Security:</strong> Always implement server-side
                authorization checks. Client-side protection is for UX only, not
                security.
              </AlertDescription>
            </Alert>
            ...
            <Alert>
              <Code2 className="h-4 w-4" />
              <AlertDescription>
                <strong>Performance:</strong> Use the useAuth hook for multiple
                checks in the same component to avoid redundant authorization
                calls.
              </AlertDescription>
            </Alert>
            ...
            <Alert>
              ...
              <AlertDescription>
                <strong>Maintainability:</strong> Keep authorization logic in
                your permissions.ts file. The Protect component will
                automatically inherit changes.
              </AlertDescription>
            </Alert>
            ...
            <Alert>
              ...
              <AlertDescription>
                <strong>UX:</strong> Always provide meaningful fallback content
                to guide users on what they need to access protected features.
              </AlertDescription>
            </Alert>
          </div>
        </CardContent>
