      ...
      {filterFields?.map((field) => {
        ...
        return (
          <AccordionItem key={value} value={value} className="border-none">
            <AccordionTrigger className="w-full items-center px-2 py-0 hover:no-underline data-[state=closed]:text-muted-foreground focus-within:data-[state=closed]:text-foreground hover:data-[state=closed]:text-foreground data-[state=open]:text-foreground">
