  ...
  return (
    <div>
      <button
        type="button"
        className={cn(
          'group flex w-full items-center rounded-lg border border-input bg-background px-3 text-muted-foreground transition-all outline-none focus-within:border-ring focus-within:ring-[3px] focus-within:ring-ring/50 hover:bg-accent/50 hover:text-accent-foreground',
          open ? 'hidden' : 'visible',
        )}
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="ml-1 hidden rounded-md p-0.5 group-aria-selected:block hover:bg-background"
                        >
                          <X className="h-4 w-4" />
                        </button>
                      </CommandItem>
