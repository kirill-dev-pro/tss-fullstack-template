          ...
          <div className="z-0">
            ...
            >
                    ...
                    {headerGroup.headers.map((header) => {
                      return (
                        <TableHead
                          ...
                          className={cn(
                            'relative truncate border-b border-border select-none last:[&>.cursor-col-resize]:opacity-0',
              ...
              <TableBody
                id="content"
                tabIndex={-1}
                className="outline-1 -outline-offset-1 outline-primary transition-colors outline-none focus-visible:outline-solid"
  ...
  return (
    <TableRow
      ...
      className={cn(
        ...
        'outline-1 -outline-offset-1 outline-primary transition-colors outline-none focus-visible:bg-muted/50 focus-visible:outline-solid data-[state=selected]:outline-solid',
